...
class GaufresHealthy extends BreakfastMenu
{
    ...
    private CottageCheese $cottageCheese;

    private AlmondMilk $almondMilk;

    private CocoOil $cocoOil;

    private Stevia $stevia;
    ...
    public function __construct(object $human)
    {
        ...
        $this->name = "Gaufre healthy";
        $this->pathLogo = "fondRond.png";
        $this->nameClass = "GaufresHealthy";
        $this->diet = ["normal"];
        $this->intolerance = ["milk", "eggs", "nuts"];
        ...
        $this->buckwheatFlour = new BuckwheatFlour($this->totalCalories * 0.13);
        $this->cottageCheese = new CottageCheese($this->totalCalories * 0.06);
        $this->almondMilk = new AlmondMilk($this->totalCalories * 0.02);
        $this->cocoOil = new CocoOil($this->totalCalories * 0.1);
        $this->stevia = new Stevia($this->totalCalories * 0.0000001);
        $this->honey = new Honey($this->totalCalories * 0.1);
        $this->strawberry = new Strawberry($this->totalCalories * 0.04);
