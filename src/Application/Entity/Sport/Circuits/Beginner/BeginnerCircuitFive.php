...
class BeginnerCircuitFive extends AbstractCircuit implements CircuitInterface
{
    ...
    public function setExplicationTexte(): void
    {
        $this->explication = [
            ...
            "    - Burpees",
            "    - Gainage",
            "    - Fentes sautées unilatéral = montée de genoux en avant",
            "    - Marche de l'ours en déplacement",
            "    - Fentes sautées unilatéral = montée de genoux en avant",
        ];
    }
