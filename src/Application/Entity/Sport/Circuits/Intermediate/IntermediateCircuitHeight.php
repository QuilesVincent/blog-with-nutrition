...
class IntermediateCircuitHeight extends AbstractCircuit
{
    ...
    public function setExplicationTexte(): void
    {
        $this->explication = [
            ...
            "    - Marche de l’ours + pompes",
            "    - Jump squat avec demi tour",
            "    - Gainage latéral sur main avec rotation (droit)",
            "    - Marche du grimpeur",
            "    - Gainage latéral sur main avec rotation (gauche)",
        ];
    }
